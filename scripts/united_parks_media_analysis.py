#!/usr/bin/env python3
"""
United Parks & Resorts Media Analysis Script with Ticket Attribution
Director of Media - Strategic Recommendations

This script analyzes paid media performance data with ticket sales attribution,
accounting for data quality issues and generates insights for strategic presentation.
"""
...
class UnitedParksMediaAnalysis:
    ...
    def load_data(self):
        """Load the main dataset with ticket attribution and filter for target park"""
        print(f"Loading United Parks & Resorts paid media data with ticket attribution for {self.target_park}...")
        try:
            ...
            missing_ticket_cols = [col for col in ticket_columns if col not in full_df.columns]
            ...
            # Show ticket attribution summary
            if 'Single-Day Tickets' in self.df.columns:
                ...
                print(f"Ticket Attribution Summary:")
    ...
    def assess_data_quality(self):
        """Assess and document data quality issues including ticket attribution"""
        print("\n" + "="*50)
        print("DATA QUALITY ASSESSMENT WITH TICKET ATTRIBUTION")
        print("="*50)
    ...
    def clean_data(self):
        """Clean the data addressing identified quality issues including ticket data"""
        print("\n" + "="*50)
        print("DATA CLEANING & PREPARATION WITH TICKET ATTRIBUTION")
        print("="*50)
    ...
    def ticket_attribution_analysis(self):
        """Analyze ticket sales attribution across channels and segments"""
        print("\n" + "="*50)
        print("TICKET ATTRIBUTION ANALYSIS")
        print("="*50)
    ...
    def performance_overview(self):
        """Analyze overall performance trends and channel effectiveness including ticket attribution"""
        print("\n" + "="*50)
        print("PERFORMANCE OVERVIEW ANALYSIS WITH TICKET ATTRIBUTION")
        print("="*50)
    ...
    def audience_segmentation_analysis(self):
        """Analyze performance by audience segments including ticket attribution"""
        print("\n" + "="*50)
        print("AUDIENCE SEGMENTATION ANALYSIS WITH TICKET ATTRIBUTION")
        print("="*50)
    ...
    def funnel_stage_analysis(self):
        """Analyze performance by funnel stages including ticket attribution"""
        print("\n" + "="*50)
        print("FUNNEL STAGE ANALYSIS WITH TICKET ATTRIBUTION")
        print("="*50)
    ...
    def comprehensive_monthly_analysis(self):
        """Conduct comprehensive monthly analysis with trends, seasonality, and strategic insights including ticket attribution"""
        print("\n" + "="*50)
        print("COMPREHENSIVE MONTHLY ANALYSIS WITH TICKET ATTRIBUTION")
        print("="*50)
    ...
    def park_performance_analysis(self):
        """Analyze performance by park with ticket attribution"""
        print("\n" + "="*50)
        print("PARK PERFORMANCE ANALYSIS WITH TICKET ATTRIBUTION")
        print("="*50)
    ...
    def create_visualizations(self):
        """Create key visualizations for the presentation including ticket attribution"""
        print("\n" + "="*50)
        print("CREATING VISUALIZATIONS WITH TICKET ATTRIBUTION")
        print("="*50)
        ...
        fig.suptitle('United Parks & Resorts - Media Performance Dashboard with Ticket Attribution', fontsize=16, fontweight='bold')
...
"""
    ...
    def run_complete_analysis(self):
        """Run the complete analysis workflow with ticket attribution"""
        print(f"UNITED PARKS & RESORTS MEDIA ANALYSIS WITH TICKET ATTRIBUTION - {self.target_park.upper()}")
        ...
        print("• CSV files for detailed performance data with ticket attribution")
